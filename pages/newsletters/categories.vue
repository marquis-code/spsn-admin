        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
          ...
          <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
            ...
            <div class="pt-6 flex justify-end gap-3">
              ...
              <button type="submit" :disabled="loading" class="px-5 py-2.5 text-base font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors shadow-sm disabled:opacity-50 flex items-center gap-2">
